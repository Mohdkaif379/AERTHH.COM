...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h3 class="text-sm font-medium text-gray-700">Rejected Withdrawals</h3>
            <p class="text-[10px] text-gray-400">View all declined vendor payout requests</p>
        </div>
    </div>

    {{-- Withdrawal List Card --}}
    <div class="bg-white rounded-xl border border-rose-100 shadow-sm overflow-hidden">
        <div class="px-6 py-4 bg-gradient-to-r from-rose-50 to-orange-50 border-b border-rose-100">
            <div class="flex items-center justify-between">
                <h3 class="text-sm font-semibold text-gray-700">Rejected Payouts List</h3>
                ...
                <div class="relative">
                    ...
                    <input type="text" 
                           ...
                           class="w-56 pl-8 pr-3 py-1.5 bg-white/90 border border-gray-200 rounded-lg focus:border-rose-300 focus:outline-none focus:ring-1 focus:ring-rose-100 transition-all duration-300 text-xs text-gray-600 placeholder-gray-400">
                </div>
            </div>
        </div>
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-gray-50 border-b border-gray-100">
                        ...
                        <th class="px-6 py-4 text-left text-[10px] font-bold text-gray-400 uppercase tracking-wider">Rejected At</th>
                ...
                <tbody class="divide-y divide-gray-50" id="table-body">
                    @forelse($rejectedWithdrawals as $index => $withdrawal)
                    <tr class="hover:bg-rose-50/20 transition-all duration-200">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center space-x-3">
                                <div class="w-8 h-8 rounded-lg overflow-hidden bg-gray-100 border border-gray-100 shrink-0 shadow-sm">
                                    ...
                                    @else
                                        <div class="w-full h-full bg-gradient-to-br from-gray-400 to-gray-500 flex items-center justify-center text-white font-bold text-[10px]">
                        ...
                        <td class="px-6 py-4">
                            <span class="text-xs font-black text-gray-400 line-through">₹{{ number_format($withdrawal->amount, 2) }}</span>
                        </td>
                        <td class="px-6 py-4">
                            <div class="flex flex-col">
                        ...
                        <td class="px-6 py-4 text-center">
                            <span class="inline-flex items-center px-2 py-0.5 bg-rose-50 text-rose-600 text-[9px] font-black uppercase rounded-full border border-rose-100">
                                <i class="fas fa-times-circle mr-1"></i> {{ $withdrawal->status }}
                            </span>
                        </td>
                    </tr>
                    @empty
