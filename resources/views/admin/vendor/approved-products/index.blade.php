...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h3 class="text-sm font-medium text-gray-700">Approved Vendor Products</h3>
            <p class="text-[10px] text-gray-400">Manage approved products from vendors</p>
        </div>
    </div>
            ...
            <table class="w-full text-xs">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-cyan-50/30 transition-colors duration-200">
                        ...
                        <td class="px-4 py-3">
                            <span class="inline-flex items-center px-2 py-1 rounded-full text-[10px] font-medium bg-emerald-50 text-emerald-600">
                                <i class="fas fa-check-circle mr-1 text-[6px] text-emerald-500"></i>
                                {{ ucfirst($product->vendor_product_status ?? 'Approved') }}
                            </span>
                        </td>
