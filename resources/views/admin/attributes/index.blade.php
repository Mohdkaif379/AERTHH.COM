...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h3 class="text-sm font-medium text-gray-700">All Attributes</h3>
            <p class="text-[10px] text-gray-400">Manage your product attributes like Size, Color, Material, etc.</p>
        </div>
    ...
    <div class="bg-white rounded-xl border border-cyan-100/50 shadow-sm overflow-hidden">
        <div class="px-6 py-4 bg-gradient-to-r from-cyan-50 to-emerald-50 border-b border-cyan-100/50">
            <div class="flex items-center justify-between">
                <h3 class="text-sm font-semibold text-gray-700">Attributes List</h3>
            ...
            <table class="w-full text-xs">
                <thead>
                    <tr class="bg-gray-50 border-y border-gray-100">
                        ...
                        <th class="px-4 py-3 text-left font-medium text-gray-500">Attribute Name</th>
                        <th class="px-4 py-3 text-left font-medium text-gray-500">Created At</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-cyan-50/30 transition-colors duration-200">
                        ...
                        <td class="px-4 py-3 text-gray-600">
                            {{ $attribute->created_at ? $attribute->created_at->format('d M Y, h:i A') : '—' }}
                        </td>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center space-x-2">
                                ...
                                <button type="button"
                                   onclick="openDeleteModal({{ $attribute->id }}, '{{ $attribute->attribute_name }}')"
                    ...
                    <tr>
                        <td colspan="4" class="px-4 py-8 text-center text-gray-400 text-xs">
                            ...
                            No attributes found
                            <a href="{{ route('attribute.create') }}" class="block mt-2 text-cyan-500 hover:text-cyan-600">
        ...
        <div class="px-6 py-3 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
            <p class="text-[10px] text-gray-400">
                Showing {{ $attributes->count() }} {{ Str::plural('entry', $attributes->count()) }}
            </p>
        </div>
    </div>
</div>
...
function openDeleteModal(itemId, itemName) {
    ...
    deleteButton.href = `{{ url('admin/attribute/delete') }}/${itemId}`;
