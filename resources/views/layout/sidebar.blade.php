    ...
    <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
        ...
        <div x-data="{ vendorOpen: false }" class="space-y-1">
            ...
            <div x-show="vendorOpen"
                ...
                {{-- Denied Products --}}
                <a href="{{ route('vendor.products.rejected') }}" class="sidebar-link flex items-center justify-between px-3 py-2 rounded-lg text-gray-600 hover:bg-gradient-to-r hover:from-cyan-50 hover:to-emerald-50 transition-all duration-300 text-xs">
                    <div class="flex items-center space-x-2">
        ...
        <div x-data="{ customersOpen: false }" class="space-y-1">
            ...
            <div x-show="customersOpen"
                ...
                {{-- Customer List --}}
                <a href="{{route('customers.index')}}" class="sidebar-link flex items-center justify-between px-3 py-2 rounded-lg text-gray-600 hover:bg-gradient-to-r hover:from-cyan-50 hover:to-emerald-50 transition-all duration-300 text-xs">
                    <div class="flex items-center space-x-2">
                        <i class="fas fa-list w-4 text-cyan-400 text-[10px]"></i>
